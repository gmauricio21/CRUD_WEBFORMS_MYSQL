...
<body class="top">
    <div class="page">
        <form class="form" method="post" runat="server">
            <asp:Label CssClass="titulo" ID="lblTitulo" runat="server" Text="Cadastro de Funcionário"></asp:Label>
            <br />
            <asp:Label CssClass="label" ID="lblNome" runat="server" Text="Nome completo"></asp:Label>
            ...
            <br />
            <div class="row">
                <asp:Button CssClass="btn" ID="btnSalvar" runat="server" Text="CADASTRAR" OnClick="btnSalvar_click" />
                <br />
                <br />
            </div>
            <div class="lista">
